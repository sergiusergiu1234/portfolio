...
const ProjectSection3 = () =>{
    ...
    return ( <motion.div ref={containerRef} variants={{hidden:{opacity:0}, visible:{opacity:1}}} transition={{duration: 0.5, delay: 0.2}} initial='hidden' animate={controls} className="bg-[#2e2e2d] h-max font-rubik_mono_one_two">
